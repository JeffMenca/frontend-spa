...
export async function GET(
  ...
  try {
    // TODO(backend-swap): conference GET /rooms/{id} (port 8082)
...
export async function PUT(
  ...
  try {
    ...
    // TODO(backend-swap): conference PUT /rooms/{id} (port 8082)
...
export async function DELETE(
  ...
  const { id } = await params;
  try {
    // TODO(backend-swap): conference DELETE /rooms/{id} (port 8082)
