...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    // TODO(backend-swap): conference POST /attendance/register (port 8082)
    return NextResponse.json(await activeConference.registerAttendance(body, token), { status: 201 });
  } catch {
