...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    // TODO(conf-service): swap mock when conference GET /reports/earnings is deployed - tracked in backlog Lane B
    return NextResponse.json(await activeConference.getPlatformEarningsReport(token, params));
  } catch (error) {
