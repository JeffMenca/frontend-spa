...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    // TODO(backend-swap): conference GET /reports/congresses-by-institution (port 8082)
    return NextResponse.json(await activeConference.getCongressesByInstitutionReport(token, params));
  } catch {
