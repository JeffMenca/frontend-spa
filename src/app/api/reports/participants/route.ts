...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    // TODO(conf-service): swap mock when conference GET /reports/participants is deployed - tracked in backlog Lane B
    return NextResponse.json(await activeConference.getParticipantReport(token, params));
  } catch (error) {
